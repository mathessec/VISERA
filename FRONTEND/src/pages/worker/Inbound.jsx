...
export default function Inbound() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Inbound Shipment Processing</h1>
        <p className="text-gray-600 mt-1">Scan packages and verify with AI-powered inspection</p>
      </div>
      ...
      {!selectedShipment ? (
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <Progress value={getVerifiedCount()} max={packages.length} />
            </CardContent>
          </Card>
